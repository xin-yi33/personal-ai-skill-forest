...
对比基线：BM25、FAISS (IVF+PQ)、HNSW、FAISS+Rerank、技能森林。

| 指标 | BM25 | FAISS (IVF+PQ) | HNSW | FAISS+Rerank | 技能森林 |
|------|------|----------------|------|-------------|---------|
| Accuracy@5 | — | 0.536 | — | — | **0.583** |
| MRR | — | 0.170 | — | — | **0.219** |
| 端到端 Token | — | 612 | — | ~1200 | **127** |
| 链完整率 | — | 0.363 | — | — | **1.000** |

*注：BM25、HNSW、FAISS+Rerank 结果待实验执行后填充。FAISS+Rerank Token 估算基于 20 候选检索+重排序模型。*
